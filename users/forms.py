...
from .models import CustomUser, Principal_investigator,Std_details
from dashboard.models import collaborations, Co_Investigator, project_details, Time_Frame,study_design, pat_sel_id, study_step, work_up, prog_report, comp_report, clinical_studies
...
class CustomGuideCreationForm(UserCreationForm):
    ...
    def save(self):
        ...
        user.type = 2
        user.save()
        guide = Principal_investigator.objects.create(principal_id=user)
        guide.save()
        return user
