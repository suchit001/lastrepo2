    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completion_report_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.comp_report')),
                ('feedback_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.feedback')),
                ('progress_report_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.prog_report')),
            ],
        ),
        migrations.CreateModel(
            name='protocol_amend',
